...
contract FlightSuretyData {
    ...
    function repayPassengerForFlight(
        ...
        for (uint256 i = 0; i < passengerCount; i++) {
            ...
            uint256 insurance = flights[flightKey].insuranceByPassenger[
                passenger
            ];
            ...
            if (insurance > 0) {
                ...
                uint256 payout = SafeMath.add(
                    insurance,
                    SafeMath.div(insurance, 2)
                );
                passenger.transfer(payout);
            }
        }
    ...
    function voteForAirline(address airline, address airlineVoter)
        external
    ...
    function payFundForAirline(address airline)
        external
        payable
        requireIsOperational
    {
